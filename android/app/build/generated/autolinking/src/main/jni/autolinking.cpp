...
auto module_rnstripe = rnstripe_ModuleProvider(moduleName, params);
if (module_rnstripe != nullptr) {
return module_rnstripe;
}
...
providerRegistry->add(concreteComponentDescriptorProvider<AddToWalletButtonComponentDescriptor>());
providerRegistry->add(concreteComponentDescriptorProvider<AddressSheetViewComponentDescriptor>());
providerRegistry->add(concreteComponentDescriptorProvider<ApplePayButtonComponentDescriptor>());
providerRegistry->add(concreteComponentDescriptorProvider<AuBECSDebitFormComponentDescriptor>());
providerRegistry->add(concreteComponentDescriptorProvider<CardFieldComponentDescriptor>());
providerRegistry->add(concreteComponentDescriptorProvider<CardFormComponentDescriptor>());
providerRegistry->add(concreteComponentDescriptorProvider<EmbeddedPaymentElementViewComponentDescriptor>());
providerRegistry->add(concreteComponentDescriptorProvider<GooglePayButtonComponentDescriptor>());
providerRegistry->add(concreteComponentDescriptorProvider<StripeContainerComponentDescriptor>());
