...
protected:
  ...
  template <typename OnCustomPaymentMethodConfirmHandlerCallbackType> void emitOnCustomPaymentMethodConfirmHandlerCallback(OnCustomPaymentMethodConfirmHandlerCallbackType value) {
    static_assert(bridging::supportsFromJs<OnCustomPaymentMethodConfirmHandlerCallbackType, jsi::Object>, "value cannnot be converted to jsi::Object");
    static_cast<AsyncEventEmitter<jsi::Value>&>(*delegate_.eventEmitterMap_["onCustomPaymentMethodConfirmHandlerCallback"]).emit([jsInvoker = jsInvoker_, eventValue = value](jsi::Runtime& rt) -> jsi::Value {
      return bridging::toJs(rt, eventValue, jsInvoker);
    });
  }
...
private:
  ...
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      ...
      eventEmitterMap_["onCustomPaymentMethodConfirmHandlerCallback"] = std::make_shared<AsyncEventEmitter<jsi::Value>>();
    }
