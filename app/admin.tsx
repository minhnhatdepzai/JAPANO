...
export default function AdminScreen() {
  ...
  const renderOverview = () => (
    <View style={styles.pageGap}>
      ...
      {/* Trạng thái server AI + lỗi mới nhất */}
  ...
  const renderTryon2d = () => (
    <View style={styles.pageGap}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.userMeta}>Lấy ảnh sản phẩm: gửi cả gallery (tối đa 6 ảnh) cho model để thử đồ hợp lý hơn.</Text>
      </View>
      <View style={styles.card}>
        <SectionHeader title="Lịch sử thử đồ (ảnh vào / ảnh kết quả)" subtitle="Cần bật lưu lịch sử ở backend" />
        <Text style={styles.emptyText}>Chưa bật lưu lịch sử ảnh. Để hiện danh sách ảnh người dùng / ảnh quần áo / ảnh kết quả kèm seed/steps/cfg và nút chạy lại, cần thêm collection lưu mỗi lượt thử đồ ở backend (mình có thể làm ở vòng sau).</Text>
      </View>
    </View>
  );
  ...
  const renderModel3d = () => (
    <View style={styles.pageGap}>
      <SectionHeader title="Quản lý mẫu 3D" subtitle="Số lượt dựng 3D và trạng thái. GLB storage cần backend lưu file." right={<Text style={styles.counterPill}>{formatNumber(kpis.tryon3d || 0)} lượt</Text>} />
      <View style={styles.statsGrid}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.emptyText}>Hiện 3D trả về khung hình nhiều góc (turntable). Để có danh sách file .glb + ảnh đầu vào + nút xem/tải/xóa + trạng thái TripoSR + thời gian dựng, cần backend lưu file GLB (TripoSR/SF3D) và metadata. Có thể bổ sung ở vòng sau.</Text>
      </View>
    </View>
  );
  ...
  const renderBotChat = () => (
    <View style={styles.pageGap}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.userMeta}>{formatNumber(bannedWords.length)} từ đang chặn. Vào tab Từ cấm để thêm/xoá.</Text>
      </View>
      <View style={styles.card}>
...
const styles = StyleSheet.create({
  ...
  sidebarLogo: { width: 34, height: 34, borderRadius: 12, backgroundColor: ADMIN_GREEN, alignItems: "center", justifyContent: "center" },
  ...
  navBadge: { marginLeft: "auto", backgroundColor: ADMIN_GREEN, color: "#fff", paddingHorizontal: 7, paddingVertical: 2, borderRadius: 12, fontSize: 10, overflow: "hidden" },
  ...
  sidebarAvatar: { width: 34, height: 34, borderRadius: 12, backgroundColor: ADMIN_GREEN, alignItems: "center", justifyContent: "center" },
  ...
  searchBox: { flex: 1, maxWidth: 420, minHeight: 42, borderWidth: 1, borderColor: ADMIN_BORDER, backgroundColor: "#FAFBFC", borderRadius: 12, paddingHorizontal: 12, flexDirection: "row", alignItems: "center", gap: 9 },
  searchInput: { flex: 1, fontSize: 14, color: ADMIN_TEXT },
  topIconBtn: { width: 42, height: 42, borderRadius: 12, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: ADMIN_BORDER, backgroundColor: "#fff" },
  ...
  pageGap: { gap: 18 },
  heroCard: { minHeight: 108, borderRadius: 12, backgroundColor: ADMIN_DARK, padding: 24, flexDirection: "row", alignItems: "center", gap: 18, overflow: "hidden" },
  ...
  statCard: { flexGrow: 1, flexBasis: 220, minHeight: 150, borderRadius: 12, backgroundColor: ADMIN_CARD, borderWidth: 1, borderColor: ADMIN_BORDER, padding: 18 },
  ...
  card: { flexGrow: 1, flexBasis: 300, borderRadius: 12, backgroundColor: ADMIN_CARD, borderWidth: 1, borderColor: ADMIN_BORDER, padding: 18, gap: 15, ...ADMIN_CARD_SHADOW },
  ...
  segmentActive: { backgroundColor: "#fff", color: ADMIN_TEXT, paddingHorizontal: 12, paddingVertical: 7, borderRadius: 12, fontSize: 12, fontWeight: "900", overflow: "hidden" },
  ...
  miniBarTrack: { flex: 1, width: "100%", minHeight: 54, borderRadius: 12, backgroundColor: "#EEF3F6", overflow: "hidden", justifyContent: "flex-end" },
  ...
  goalCircle: { alignSelf: "center", width: 150, height: 150, borderRadius: 12, borderWidth: 15, borderColor: ADMIN_GREEN, alignItems: "center", justifyContent: "center", marginTop: 10 },
  ...
  hTrack: { height: 9, backgroundColor: "#EEF3F6", borderRadius: 12, overflow: "hidden" },
  hFill: { height: "100%", borderRadius: 12 },
  ...
  funnelTrack: { height: 10, borderRadius: 12, backgroundColor: "#EEF3F6", overflow: "hidden", marginTop: 6 },
  funnelFill: { height: "100%", borderRadius: 12 },
  funnelRates: { flexDirection: "row", flexWrap: "wrap", gap: 12, marginTop: 4 },
  rateText: { fontSize: 12, fontWeight: "900" },
  activityRow: { flexDirection: "row", alignItems: "center", gap: 12 },
  activityIcon: { width: 34, height: 34, borderRadius: 12, backgroundColor: "#E9F8F1", alignItems: "center", justifyContent: "center" },
  ...
  featureChip: { color: ADMIN_TEXT, backgroundColor: "#F1F4F6", paddingHorizontal: 10, paddingVertical: 7, borderRadius: 12, overflow: "hidden", fontSize: 12, fontWeight: "900" },
  predictionGrid: { flexDirection: "row", flexWrap: "wrap", gap: 14 },
  predictionCard: { flexGrow: 1, flexBasis: 360, borderRadius: 12, backgroundColor: ADMIN_CARD, borderWidth: 1, borderColor: ADMIN_BORDER, padding: 14, flexDirection: "row", alignItems: "center", gap: 12 },
  predictionImage: { width: 64, height: 64, borderRadius: 12, backgroundColor: "#F1F4F6", alignItems: "center", justifyContent: "center" },
  ...
  scoreBox: { width: 60, height: 60, borderRadius: 12, backgroundColor: "#ECFFF7", alignItems: "center", justifyContent: "center" },
  ...
  mediaUploadBox: { borderWidth: 1, borderColor: "#D8F3E6", backgroundColor: "#F6E7E3", borderRadius: 12, padding: 12, gap: 8 },
  ...
  secondaryBtnWide: { minHeight: 44, borderRadius: 12, borderWidth: 1, borderColor: ADMIN_GREEN, backgroundColor: "#F6E7E3", paddingHorizontal: 16, alignItems: "center", justifyContent: "center", alignSelf: "flex-start" },
  secondaryBtnText: { color: ADMIN_TEXT, fontSize: 13, fontWeight: "900" },
  smallBtn: { minHeight: 36, borderRadius: 12, borderWidth: 1, borderColor: ADMIN_BORDER, paddingHorizontal: 11, alignItems: "center", justifyContent: "center", backgroundColor: "#fff" },
  smallBtnText: { color: ADMIN_TEXT, fontSize: 12, fontWeight: "900" },
  saleBtn: { minHeight: 36, borderRadius: 12, backgroundColor: "#FFF7E6", borderWidth: 1, borderColor: "#F3D38A", paddingHorizontal: 11, alignItems: "center", justifyContent: "center" },
  saleBtnText: { color: "#B45309", fontSize: 12, fontWeight: "900" },
  dangerBtn: { minHeight: 36, borderRadius: 12, backgroundColor: "#FFF1F2", borderWidth: 1, borderColor: "#FBC4C8", paddingHorizontal: 11, alignItems: "center", justifyContent: "center" },
  dangerBtnText: { color: ADMIN_RED, fontSize: 12, fontWeight: "900" },
  marketPreview: { flexGrow: 1, flexBasis: 300, borderRadius: 12, backgroundColor: "#fff", borderWidth: 1, borderColor: ADMIN_BORDER, overflow: "hidden" },
  ...
  previewDiscount: { position: "absolute", left: 16, top: 16, backgroundColor: ADMIN_RED, paddingHorizontal: 10, paddingVertical: 7, borderRadius: 12 },
  ...
  messageBox: { borderWidth: 1, borderColor: ADMIN_BORDER, borderRadius: 12, padding: 12, flexDirection: "row", alignItems: "center", gap: 10 },
  messageText: { flex: 1, color: "#111", backgroundColor: "#F0F1F6", borderRadius: 12, paddingHorizontal: 12, paddingVertical: 9, fontWeight: "700" },
  sendPill: { backgroundColor: ADMIN_BLUE, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 9 },
  sendText: { color: "#fff", fontWeight: "900" },
  productListGrid: { flexDirection: "row", flexWrap: "wrap", gap: 14 },
  productCard: { flexGrow: 1, flexBasis: 350, borderRadius: 12, backgroundColor: ADMIN_CARD, borderWidth: 1, borderColor: ADMIN_BORDER, padding: 14, gap: 12 },
  productTop: { flexDirection: "row", gap: 12 },
  productImage: { width: 78, height: 78, borderRadius: 12, backgroundColor: "#F1F4F6", alignItems: "center", justifyContent: "center" },
  ...
  discountBadge: { color: "#fff", backgroundColor: ADMIN_RED, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 12, overflow: "hidden", fontSize: 11, fontWeight: "900" },
  ...
  counterPill: { color: ADMIN_GREEN, backgroundColor: "#E9F8F1", paddingHorizontal: 10, paddingVertical: 7, borderRadius: 12, overflow: "hidden", fontSize: 12, fontWeight: "900" },
  promoGrid: { flexDirection: "row", flexWrap: "wrap", gap: 16 },
  selectChip: { borderWidth: 1, borderColor: ADMIN_BORDER, borderRadius: 12, paddingHorizontal: 12, paddingVertical: 8, backgroundColor: "#fff" },
  ...
  tableCard: { borderRadius: 12, backgroundColor: ADMIN_CARD, borderWidth: 1, borderColor: ADMIN_BORDER, overflow: "hidden" },
  userRow: { padding: 14, flexDirection: "row", alignItems: "center", gap: 12, borderBottomWidth: 1, borderBottomColor: "#F0F2F4", flexWrap: "wrap" },
  userAvatar: { width: 42, height: 42, borderRadius: 12, backgroundColor: "#E9F8F1", alignItems: "center", justifyContent: "center" },
  ...
  rolePill: { borderWidth: 1, borderColor: ADMIN_BORDER, borderRadius: 12, paddingHorizontal: 10, paddingVertical: 6, backgroundColor: "#fff" },
  ...
  loadingCard: { minHeight: 220, borderRadius: 12, backgroundColor: "#fff", borderWidth: 1, borderColor: ADMIN_BORDER, alignItems: "center", justifyContent: "center", gap: 12 },
  authPage: { flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: ADMIN_BG, padding: 20 },
  authCard: { width: "100%", maxWidth: 420, borderRadius: 12, backgroundColor: "#fff", borderWidth: 1, borderColor: ADMIN_BORDER, padding: 26, alignItems: "center", gap: 14 },
  logoBox: { width: 54, height: 54, borderRadius: 12, backgroundColor: ADMIN_GREEN, alignItems: "center", justifyContent: "center" },
  ...
  authButton: { minHeight: 46, alignSelf: "stretch", backgroundColor: ADMIN_GREEN, borderRadius: 12, alignItems: "center", justifyContent: "center" },
  authButtonText: { color: "#fff", fontSize: 14, fontWeight: "900" },

  // ML visuals
  modelRow: { flexDirection: "row", flexWrap: "wrap", gap: 12 },
  modelCard: { flexGrow: 1, minWidth: 200, backgroundColor: ADMIN_CARD, borderWidth: 1, borderColor: ADMIN_BORDER, borderRadius: 12, padding: 14, gap: 4 },
  ...
  metricPill: { flexGrow: 1, minWidth: 120, backgroundColor: ADMIN_BG, borderWidth: 1, borderColor: ADMIN_BORDER, borderRadius: 12, padding: 10, gap: 2 },
  ...
  legendDot: { width: 14, height: 14, borderRadius: 12 },
  ...
  segDot: { width: 16, height: 16, borderRadius: 12 },
  ...
  bannedChip: { flexDirection: "row", alignItems: "center", gap: 6, paddingVertical: 8, paddingHorizontal: 12, borderWidth: 1, borderColor: ADMIN_BORDER, backgroundColor: ADMIN_BG, borderRadius: 12 },
  ...
  statusChip: { paddingVertical: 3, paddingHorizontal: 9, borderRadius: 12 },
