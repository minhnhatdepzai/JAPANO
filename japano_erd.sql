-- =============================================================
-- JAPANO — Sơ đồ quan hệ thực thể (ERD) cho MySQL / MariaDB
...
DROP DATABASE IF EXISTS `japano`;
CREATE DATABASE `japano` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `japano`;
