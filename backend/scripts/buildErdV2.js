// Sinh ERD v2 (đã chuẩn hoá) cho JAPANO từ một định nghĩa schema DUY NHẤT:
//   - japano_erd.dbml            -> dán vào dbdiagram.io để KHÁCH DUYỆT sơ đồ
...
fs.writeFileSync(path.join(ROOT, 'japano_erd.dbml'), emitDbml());
...
console.log('Đã ghi japano_erd.dbml + japano_schema_v2.sql + japano_schema_v2_sqlite.sql');
