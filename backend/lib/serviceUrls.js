...
const MOTION_ENGINE_LABEL = String(process.env.JAPANO_MOTION_ENGINE_LABEL || 'one-to-all-animation-1.3b-v1').trim();
...
// Sentence-transformer đa ngôn ngữ (embedding_service.py) — CUDA khi có GPU.
const EMBEDDING_URL = String(process.env.JAPANO_EMBEDDING_URL || 'http://127.0.0.1:7865').replace(/\/+$/, '');

module.exports = { CATVTON_URL, FASHN_URL, MOTION_URL, MOTION_ENGINE_LABEL, AI_GATEWAY_URL, OLLAMA_URL, EMBEDDING_URL };
