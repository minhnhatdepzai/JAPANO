...
module.exports = function registerJapanSpotsRoutes(api, ctx) {
  const { read, update, httpError, moderateReview, REVIEW_MODERATION_MODEL, uploadReviewMedia, mongoEnabled, getDb } = ctx;
  ...
  api.delete('/japan-spots/reviews/:id', async (req, res) => {
  ...
  api.delete('/japan-spots/suggestions/:id', async (req, res) => {
