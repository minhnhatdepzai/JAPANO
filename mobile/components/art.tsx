...
export const Hanko = ({ size=34, label='ジ' }:{size?:number;label?:string}) => (
  <View style={{ width:size, height:size, borderWidth:2, borderColor:C.primary, borderRadius:8,
...
export const Fuji = ({ height=120 }:{height?:number}) => (
  <Svg width="100%" height={height} viewBox="0 0 100 90" preserveAspectRatio="xMidYMid slice">
    ...
    <Circle cx="26" cy="26" r="12" fill={'rgba(255,255,255,0.72)'} opacity={0.9} />
...
export const GasshoVillage = ({ height=180 }:{height?:number}) => (
  <Svg width="100%" height={height} viewBox="0 0 120 80" preserveAspectRatio="xMidYMid slice">
    ...
    <Circle cx="96" cy="17" r="10" fill={C.washi2} opacity={0.78}/>
    ...
    <G>
      ...
      <Path d="M8 56 L24 34 L40 56 Z" fill={C.ink} />
      <Path d="M10 54 L24 36 L38 54" fill="none" stroke={C.card} strokeWidth="3" strokeLinecap="round" />
      <Rect x="21" y="60" width="6" height="11" fill="#412D24" />
      <Rect x="29" y="59" width="4" height="4" fill={C.shu} />
    </G>
    <G>
      <Rect x="48" y="49" width="31" height="23" rx="1" fill="#8A6246" />
      <Path d="M42 51 L63.5 22 L85 51 Z" fill="#392F29" />
      <Path d="M45 49 L63.5 25 L82 49" fill="none" stroke={C.card} strokeWidth="3.5" strokeLinecap="round" />
      <Rect x="60" y="60" width="7" height="12" fill="#3D2B23" />
      <Rect x="51" y="55" width="5" height="5" fill={C.shu} />
      <Rect x="71" y="55" width="5" height="5" fill={C.shu} />
    </G>
    <G>
      <Rect x="88" y="57" width="20" height="14" rx="1" fill="#79543E" />
      <Path d="M84 58 L98 39 L112 58 Z" fill="#40352E" />
      <Path d="M86 56 L98 41 L110 56" fill="none" stroke={C.card} strokeWidth="2.5" strokeLinecap="round" />
...
export const GarmentTile = ({ bg=C.matcha, fg=C.washi2 }:{bg?:string;fg?:string}) => (
