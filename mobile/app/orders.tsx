...
const st = StyleSheet.create({
  ...
  card:{ backgroundColor:C.card, borderWidth:1, borderColor:C.line, borderRadius:14, padding:14, marginTop:12 },
  ...
  ghostBtn:{ borderWidth:1, borderColor:C.line, borderRadius:999, paddingVertical:6, paddingHorizontal:12, backgroundColor:C.card },
});
