...
const st = StyleSheet.create({
  ...
  editDot:{ position:'absolute', bottom:2, right:2, width:28, height:28, borderRadius:14, backgroundColor:C.shu, alignItems:'center', justifyContent:'center', borderWidth:2, borderColor:C.washi },
