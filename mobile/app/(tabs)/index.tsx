...
import { Seigaiha } from '../../components/art';
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={st.hero}>
          ...
          <View style={{ position:'absolute', left:18, bottom:16, right:18 }}>
            <Text style={{ fontFamily:F.displaySb, letterSpacing:3, fontSize:10, color:'#f0d9b6' }}>BỘ SƯU TẬP THU · SẮC LÁ ĐỎ</Text>
            <Text style={{ fontFamily:F.displayX, fontSize:27, color:'#fff', marginTop:4, marginBottom:10 }}>Sắc trầm{'\n'}mùa lá đỏ</Text>
            <Pressable style={st.heroBtn} onPress={()=>router.push('/category/ao-truyen-thong')}>
        ...
        <View style={{ paddingHorizontal:18 }}>
          ...
          <View style={[st.grid,{ marginTop:16, marginBottom:24 }]}>
            ...
            <Pressable style={st.quick} onPress={()=>{if(requireAuth('/goals'))router.push('/goals');}}>
              ...
              <Text style={st.quickT}>Mục tiêu mua sắm</Text><Text style={st.quickS}>khỏe hơn · tiết kiệm hơn</Text>
            </Pressable>
          </View>
        </View>
      </ScrollView>
