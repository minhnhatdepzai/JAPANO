...
const st = StyleSheet.create({
  ...
  input:{ minHeight:48, borderWidth:1, borderColor:C.line, borderRadius:12, backgroundColor:C.card, paddingHorizontal:13, fontFamily:F.body, fontSize:14, color:C.ink, marginBottom:13, justifyContent:'center' },
  ...
  social:{ flex:1, height:46, borderWidth:1, borderColor:C.line, borderRadius:12, backgroundColor:C.card, flexDirection:'row', alignItems:'center', justifyContent:'center', gap:8 },
