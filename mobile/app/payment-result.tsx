...
const st=StyleSheet.create({
  ...
  flagAward:{width:'100%',flexDirection:'row',alignItems:'center',gap:11,backgroundColor:C.inverseSurface,borderWidth:1,borderColor:C.kin,borderRadius:16,padding:13,marginTop:16},
  ...
  card:{width:'100%',backgroundColor:C.card,borderWidth:1,borderColor:C.line,borderRadius:16,padding:14,marginTop:20},
