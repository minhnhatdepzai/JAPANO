...
const st = StyleSheet.create({
  ...
  hero: { backgroundColor:C.inverseSurface, borderRadius: 18, padding: 17, marginTop: 4 },
  ...
  timer: { width: '48%', backgroundColor:C.card, borderWidth: 1, borderColor: C.line, borderRadius: 13, padding: 11, alignItems: 'center' },
  ...
  stageCard: { flex: 1, backgroundColor:C.card, borderWidth: 1.5, borderRadius: 14, padding: 12, marginBottom: 10 },
  ...
  plainBox: { backgroundColor:C.card, borderWidth: 1, borderColor: C.line, borderRadius: 14, padding: 13 },
